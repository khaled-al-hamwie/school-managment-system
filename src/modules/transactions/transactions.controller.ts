...
import { findAllStudentTransactionDto } from "./dto/findAll-student-transaction.dto";
import { findAllTeacherTransactionDto } from "./dto/findAll-teacher-transaction.dto";
...
import { findAllPageOptions } from "./options/findAll.page.options";
...
export class TransactionsController {
    ...
    findAllStudent(
        ...
        @Query() query: findAllStudentTransactionDto,
        @Query("page", ParseIntPagePipe) page: number,
    ) {
        const whereWrapperObject = whereWrapperTransform(query);
        return this.transactionsService.findAll({
    ...
    findAllTeacher(
        @User("teacher_id") teacher_id: TeacherAttributes["teacher_id"],
        @Query() query: findAllTeacherTransactionDto,
        @Query("page", ParseIntPagePipe) page: number,
    ) {
        const whereWrapperObject = whereWrapperTransform(query);
        return this.transactionsService.findAll({
